...
You can also use the sysroot generation script, which leverages qemu and docker to build cross-compilation sysroot and adi libraries for targeting ADRV9009. the script has been tested and verified, and the output matches exactly that of the one given in the release section. still, no guarantees. if you're unsure, just download the prebuilt binaries. 
